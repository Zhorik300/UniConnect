...
func CreatePostHandler(c *gin.Context) {
    ...
    res, err := database.DB.NamedExec(`INSERT INTO posts (title, content, author_id, created_at, updated_at)
        VALUES (:title, :content, :author_id, :created_at, :updated_at)`, &post)
    if err != nil {
